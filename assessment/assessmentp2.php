...
&lt;/html&gt;
        ...
        <p>
          ...
          var_dump($vardump);
          echo($br);
          var_dump($vardump2);var_dump(is_int($vardump2));
          echo($br);    
        ...
        <form action=impressed_get.php method="get">
          <table> 
            ...
            <tr> <td>Zijn we onder de indruk?</td><td><input type="radio" name="impressed" value="onder de indruk">Jazeker 
                                             <input type="radio" name="impressed" value="niet onder de indruk">Nee, niet echt</td></tr>
        </table>
        <input type="submit">
